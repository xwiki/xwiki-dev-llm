...
| [extensions.xwiki.org](https://extensions.xwiki.org) | Catalog + docs of all free extensions; the source used by in-product Extension Manager. | No MCP. WebFetch an extension page (e.g. to find an extension id/version). |
