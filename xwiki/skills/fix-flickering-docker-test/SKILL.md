...
4. Try to reproduce the flickering on Firefox with ``mvn clean install -Dit.test=TestClass#testMethod -Dxwiki.test.ui.browser=firefox``; this creates a new XWiki test instance
